...
export default class Footer extends Component {
    render() {
        return (
            <div class="text-center lg:text-left bg-catalog text-gray-600 h-32">
                <div class="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
                    <div class="mr-12 hidden lg:block">
                        <span>Get connected with us on social networks:</span>
                    </div>
                    <div class="flex justify-center">
                        <a href="https://www.facebook.com/guccdesis/" class="mr-6 text-gray-600">
                        ...
                        <a href="https://www.instagram.com/guccdesis/" class="mr-6 text-gray-600">
                ...
                <div class="text-center p-6 bg-white">
                    <span>© 2021 </span>
                    <a class="text-gray-600 font-semibold" href="https://mdbootstrap.com/">GUCCdéSIS</a>
                </div>
            </div>
        )
    }
