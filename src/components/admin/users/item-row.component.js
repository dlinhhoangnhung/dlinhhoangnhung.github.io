            ...
            <tr className="hover:bg-gray-200">
                <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                        ...
                        <div onClick={e => window.location.href = '/admin-view/product/' + this.props.item.product} className="flex-shrink-0 h-10 w-3/5 flex ">
                ...
                <td onClick={() => console.log(this.props.item)} className="px-6 py-4 ml-10 whitespace-nowrap">
                    <div className="text-sm text-gray-900">{this.props.item.shippingInfo}</div>
                    <div className="text-sm text-gray-500">IT</div>
                </td>
                <td className="px-6 py-4 space-x-4 ">
                    <Link to={"/edit/product/" + this.props.item._id}>
                        <span
