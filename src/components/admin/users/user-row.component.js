            ...
            <tr className="hover:bg-gray-200">
                <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                        <span
                            onClick={() => { this.props.deleteUser(this.props.user._id) }} // chua lam
                        >
                        ...
                        <a href={`/admin-view/user/${this.props.user._id}`}>
                            <div className="flex-shrink-0 h-10 w-3/5 flex ">

                                <div className="mt-3">
                                    {/* <input type="checkbox" className="form-checkbox" checked={this.state.checked} onChange={this.handleChange} /> */}
                ...
                <td className="px-6 py-4 ml-10 whitespace-nowrap">
                    ...
                    <div className="text-sm text-gray-500">{this.props.user.role}</div>
                </td>
                <td className="px-6 py-4 space-x-4 ">
                    <Link to={"/edit/user/" + this.props.user._id}>
                        <span
