  ...
  render() {
    ...
    return (
      <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <div class="subheader py-2 py-lg-4 subheader-solid" style={{ width: 'auto' }} id="kt_subheader">
        ...
        <div class="d-flex flex-column-fluid">
          <div class="" style={{ paddingLeft: '40px' }}>
                    ...
                    <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                      ...
                      <div class="navi-item mb-2">
                        <a href="#" class="navi-link py-4" data-toggle="tooltip" title="" data-placement="right" data-original-title="Coming soon...">
                          ...
                          <a href="/user/orders">
                            <span class="navi-text font-size-lg">Orders</span>
                          </a>
                          <span class="navi-label">
                            <span class="label label-light-primary label-inline font-weight-bold">new</span>
                          </span>
