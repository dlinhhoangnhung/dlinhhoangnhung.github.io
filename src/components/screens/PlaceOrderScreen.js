...
export default function PlaceOrderScreen({ item }, props) {
    ...
    return (
        <div className='bg-indigo-50 h-full'>
            <Navbar />
            <div className='bg-indigo-50 incol space-y-4 mt-20'>
                {/* <CheckoutSteps className="mb-10" step1 step2 step3></CheckoutSteps> */}
                ...
                <div class="h-screen grid grid-cols-3">
                    ...
                    <div class="col-span-1 bg-white lg:block hidden">
                        <h1 class="py-6 border-b-2 text-xl text-gray-600 px-8">Hoá đơn</h1>
