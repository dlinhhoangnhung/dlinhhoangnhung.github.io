    ...
    return (
        <div>
            ...
            <Switch>
                ...
                <PrivateRoute Route exact path="/user-info/shipping" component={ShippingAddressScreen}></PrivateRoute>
                <PrivateRoute Route path="/user-info/placeorder" component={PlaceOrderScreen}></PrivateRoute>
